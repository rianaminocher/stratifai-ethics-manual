...
**Description** In the events where there is a ***discrepancy*** between the predictions of the tool and the medical opinion of the healthcare professional, a process protocol for decision-making dilemmas customized for ***healthcare professional expertise level*** must be described.

***discrepancy:*** difference in recommended course of treatment; difference in output *from existing medical device*;\
***healthcare professional expertise level:*** early; proficient; expert
...
**Description** ***End-users*** should have sufficient control over model selection and platform ***parameters*** to foster independent use and trust in the system predictions.
