...
***valid methodology***: *TBD*; *set of ways in which predictions will be shown in platform*   
...
**Description**  A standardized ***procedure*** for explaining ***risks*** of oversight customized for patient ***subgroups*** must be designed.  
...
***trust:*** *operational definitions of trust*
...
***discrepancy:*** *acceptable threshold for difference*
...
::: {.callout-note}
This requirement is closely related to 1.1.1; 1.1.2; and 1.2.2---this requirement is tailored to end-users who are patients. Requirement 1.2.2 will enable reporting discrepancies for patients, and the execution of 1.1.2 will inform the process protocol for this requiremnt.
:::
