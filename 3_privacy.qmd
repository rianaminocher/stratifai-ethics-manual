...
***quality criteria:*** robust to missing data; robust to inaccuracies; robust to input errors; *relevant thresholds*  
...
***Relevant requirements:*** *the applicability of requirements must be translated for the STRATIF-AI platform and included in the DMP*
