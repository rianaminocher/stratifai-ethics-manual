...
***severity:*** *define metrics to measure security breach, and scale of severity*
***type:*** data poisoning; model evasion; *define types*
...
***risk:*** threat to safety; threat to validity; risk of misuse; issues with reliability; *additional risks?*  
...
***technical risks:*** vulnerability to misuse; technical robustness metrics
...
***data contexts:*** *clinical settings*  
